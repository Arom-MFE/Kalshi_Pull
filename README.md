...
Exit codes: 0 complete, 1 some tickers failed, 2 the API stayed down, 75 another run holds the lock, 130 interrupted. A usage error such as an unknown layer also exits with 2, as argparse does.
